	...
	return cli.Command{
		...
		Subcommands: []cli.Command{
			...
			},
			{
				...
				Usage: "Set up everything sparklespray needs in a GCP project that already has APIs enabled and a service account with the required IAM roles (see v100/setup-gcp-project.sh): Firestore database + composite indexes, GCS bucket, Pub/Sub topics, SparklesConfig, and an initial API key",
				Flags: []cli.Flag{
					cli.StringFlag{Name: "project"},
					cli.StringFlag{Name: "db", Value: defaultDB},
