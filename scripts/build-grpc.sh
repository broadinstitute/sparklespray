...
protoc -I protobuf/sparklespray/sparklespray protobuf/sparklespray/sparklespray/pb.proto --go_out=go/src/github.com/broadinstitute/kubequeconsume/pb --python_out=./cli --mypy_out=./cli/sparklespray
