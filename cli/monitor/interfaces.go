...
const (
	...
	// console rather than through sprinkles.
...
// sprinkles.ResourceEntry so Firestore documents round-trip correctly.
...
// Field names and tags match sprinkles.EmptyVolume so Firestore documents round-trip correctly.
...
// sprinkles.GCSMount so Firestore documents round-trip correctly.
...
// transition. Defined here (not in sprinkles) to avoid an import cycle.
...
// terminal state. Defined here (not in sprinkles) to avoid an import cycle.
...
// job reaches a terminal state. Defined here (not in sprinkles) to avoid an import
// cycle.
...
// state is persisted. Defined here (not in sprinkles) to avoid an import cycle.
...
// here (not in sprinkles) to avoid an import cycle.
...
// IncidentCount. Defined here (not in sprinkles) to avoid an import cycle.
...
// lifecycle ends. Defined here (not in sprinkles) to avoid an import cycle.
