...
def test_watch_cmd_with_verify(
    mock_check_completion,
    mock_watch,
    mock_create_cluster,
    job_queue,
    mock_io,
...
@patch("sparklespray.commands.watch.create_cluster")
@patch("sparklespray.commands.watch.watch")
def test_watch_cmd_with_jobid_pattern(
    mock_watch,
    mock_create_cluster,
    mock_resolve_jobid,
    job_queue,
