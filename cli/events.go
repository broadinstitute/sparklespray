...
// published to the sprinkles-events topic. It contains the same fields as the
...
// WorkerEvent is published to sprinkles-events and recorded in Events on worker
// lifecycle changes.
...
// TaskStateUpdate is published to sprinkles-events and recorded in Events on
...
// JobCreatedEvent is published to sprinkles-events and recorded in Events when a new job is submitted.
...
// JobTerminatedEvent is published to sprinkles-events and recorded in Events when
...
// WorkpoolStateChangeEvent is published to sprinkles-events and recorded in Events
...
// BatchFailedEvent is published to sprinkles-events and recorded in Events
...
// BatchSucceededEvent is published to sprinkles-events and recorded in Events
...
// WorkpoolIncidentEvent is published to sprinkles-events and recorded in
...
// EventPublisher writes events to the sprinkles-events Pub/Sub topic and
