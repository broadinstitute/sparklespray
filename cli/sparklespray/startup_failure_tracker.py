...
class StartupFailureTracker:
    ...
    def update(self, timestamp, tasks, completed_node_names):
        ...
        if (nodes_finished_without_running_anything + nodes_finished_processing_at_least_one) > 0:
            self.event_log.append(NodesCompleted(timestamp, nodes_finished_processing_at_least_one, 
