...
bootDiskSizeGb = 10
consume_exe_url="https://broad-achilles-kubeque.storage.googleapis.com/kubetest/dist/mock-consume"
consume_exe_args=["test", "arg"]
machine_spec = MachineSpec(boot_volume_in_gb=bootDiskSizeGb, mount_point=mount_point, machine_type="n1-standard-1")
spec = c.create_pipeline_spec(jobid=jobid, 
