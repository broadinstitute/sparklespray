...
def test_increase_size():
    r = ResizeCluster(target_node_count=2,
                      max_preemptable_attempts=0, seconds_between_modifications=0)
    state = MockClusterState(incomplete_task_count=2,
                             requested_node_count=0, preempt_attempt_count=0)
    mods = MockClusterMod()
    r(state, mods)
...
def test_increase_size_capped_by_tasks():
    r = ResizeCluster(target_node_count=2,
                      max_preemptable_attempts=0, seconds_between_modifications=0)
    state = MockClusterState(incomplete_task_count=1,
                             requested_node_count=0, preempt_attempt_count=0)
    mods = MockClusterMod()
    r(state, mods)
...
def test_add_some_preemptable():
    r = ResizeCluster(target_node_count=3,
                      max_preemptable_attempts=2, seconds_between_modifications=0)
    state = MockClusterState(incomplete_task_count=3,
                             requested_node_count=0, preempt_attempt_count=0)
    mods = MockClusterMod()
    r(state, mods)
...
def test_decrease_size():
    r = ResizeCluster(target_node_count=2,
                      max_preemptable_attempts=0, seconds_between_modifications=0)
    state = MockClusterState(incomplete_task_count=2,
                             requested_node_count=3, preempt_attempt_count=0)
    mods = MockClusterMod()
    r(state, mods)
...
def test_no_change():
    r = ResizeCluster(target_node_count=20,
                      max_preemptable_attempts=0, seconds_between_modifications=0)
    state = MockClusterState(incomplete_task_count=2,
                             requested_node_count=2, preempt_attempt_count=0)
    mods = MockClusterMod()
    r(state, mods)
    assert mods.calls == []
...
def test_frequent_calls():
    r = ResizeCluster(target_node_count=2, max_preemptable_attempts=0,
