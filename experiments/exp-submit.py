...
def create_pipeline_json(project_id,
                         zones,
                         bucket_name: str,
    ...
    mounts = [
        {
            'disk': 'ephemeralssd',
            'path': machine_specs_mount_point,
            'readOnly': False
        }
    ]
        ...
        'pipeline': {
            'actions': [
                ...
                {'imageUri': 'chiaen/docker-gcsfuse',
                    ...
                    'commands': ["gcsfuse", "--foreground", bucket_name, bucket_mount_path],
                    'mounts': mounts,
...
pipeline_def = create_pipeline_json(project_id='broad-achilles',
                                    zones=['us-central1-b'],
